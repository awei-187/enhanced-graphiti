...
class EdgeSearchConfig(BaseModel):
    ...
    structured_max_entity_candidates: int = Field(default=3)
    structured_allow_single_entity: bool = Field(default=False)
    structured_single_entity_limit: int = Field(default=3)
