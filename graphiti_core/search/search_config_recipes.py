...
# performs hybrid edge search plus query-aware structured graph search
EDGE_HYBRID_SEARCH_STRUCTURED_CROSS_ENCODER = SearchConfig(
    edge_config=EdgeSearchConfig(
        search_methods=[
            EdgeSearchMethod.bm25,
            EdgeSearchMethod.cosine_similarity,
            EdgeSearchMethod.bfs,
            EdgeSearchMethod.structured,
        ],
        reranker=EdgeReranker.cross_encoder,
    ),
    limit=10,
